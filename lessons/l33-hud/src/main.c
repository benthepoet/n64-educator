 ...
 * L33 — HUD over 3D
 *
 * Collect 3 — watch the HUD on a small island. Third-person move, follow cam,
...
int main(void)
{
    ...
    for (;;) {
        ...
        if (state == ST_TITLE) {
            rdpq_text_print(NULL, 1, 70, 70, "L33 HUD DEMO");
            rdpq_text_print(NULL, 1, 55, 100, "Collect 3 — watch the HUD");
